       ...
       private void GetMonsterAtLocation()
        ...
        public void AttackCurrentMonster()
        {
            ...
            if (CurrentMonster.HitPoints <= 0)
            {
                ...
                RaiseMessage($"Your receive {CurrentMonster.RewardExperiencePoints} experience points.");
            ...
            else
            {
                ...
                int damageToPlayer = RandomNumberGenerator.NumberBetween(CurrentMonster.MinimumDamage, CurrentMonster.MaximumPoints);
