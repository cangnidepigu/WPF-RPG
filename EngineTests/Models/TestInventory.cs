...
namespace EngineTests.Models
{
    ...
    public class TestInventory
    {
        ...
        public void Test_AddItems()
        {
            ...
            List<GameItem> itemToAdd = new List<GameItem>();
            itemToAdd.Add(ItemFactory.CreateGameItem(3001));
            itemToAdd.Add(ItemFactory.CreateGameItem(3002));

            Inventory inventory1 = inventory.AddItems(itemToAdd);

            Assert.AreEqual(2, inventory1.Items.Count);

            // chained AddItemFromFactory() calls kinda poggers ngl
